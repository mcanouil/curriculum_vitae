...
% I started working as a ``Study Engineer'' in September 2012 and in October/November 2014, I was given the opportunity to start a Ph.D. thesis on joint models applied to the genetic field.\\
...
% 
% During my six years at the CNRS UMR8199, I was able to develop R packages \cite{yengo_variable_2016}, web applications using the R package \textsc{Shiny} \cite{ndiaye_expression_2017, verbanck_low-dose_2017} and write reproducible scripts from the data reading to the article writing, using R and \textsc{Rmarkdown} \cite{canouil_jointly_2018}.\\
...
% This, combined with the standard format used for the phenotype (CDISC), allows to run the whole analysis on any cohorts' data within the same environment (Operating System, R version and R packages version).
% 
...
% 
% Working at INSERM CR1219 could be a great opportunity for me to follow up on joint models., in particular for the high expertise in longitudinal and survival data analysis with for example the R package \textsc{lcmm} and the work of Dr. Hélène JACMIN-GADDA et al.\\
% With my knowledge acquired during my Ph.D. on joint models and my computing skills, 
